...
public class CandidateGrid extends javax.swing.JFrame {
    ...
    Statement st;
    String U="Active";
    String [] cp=new String[]{"ID","Name","Age","Gender","Address","State","Country","Number","Adhar","Party","Email","Password","Status"};
       ...
       try
        {
         ...
         rs=st.executeQuery("select * from Condidateregistration");
         fillgrid(rs);
        ...
        public void votegrid()
  {
    ...
    private void initComponents() {
        ...
        cmbsearch.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Search With", "Id", "Name", "Number", "Party", "Age", "Gender", "Address", "Email", "State", " " }));
        ...
        jLabel16.setText("Condidate Detail");
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Id like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Name like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Party like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where State like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Age like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * Condidateregistration where Address like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Number like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Gender like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from Condidateregistration where Email like '%"+str+"%'");
                fillgrid(rs);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CandidateGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
