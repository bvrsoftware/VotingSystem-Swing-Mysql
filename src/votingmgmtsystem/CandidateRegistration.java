...
public class CandidateRegistration extends javax.swing.JFrame {
    ...
    public void next()
    {
       int i=0;
        try
        {
            rs=st.executeQuery("Select ID from condidateregistration order by ID desc");
            rs.next();
            i=rs.getInt(1);
            i=i+1;
            txtid.setText(i+ "");
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Condidate Registration");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cmbstate, 0, 156, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel8)
                            .addComponent(txtcountry, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
     if(!txtid.getText().equals("") && !txtname.getText().equals("") && !txtadd.getText().equals("") &&!txtadhar.getText().equals("")&& !cmbstate.getSelectedItem().equals("Select State") && ! txtage.getText().equals("") && ! txtnum.getText().equals("") && ! txtcountry.getText().equals("") && !cmbparty.getSelectedItem().equals("Select Party") && !txtemail.getText().equals("")&&!buttonGroup1.getSelection().equals(buttonGroup1.isSelected(null)))
             {
            ...
            String name, num, st, co, ge, adhar,add, age,pass,cpass,email,party,date;
            ...
            if(pass.equals(cpass)==false)
            {
                ...
                try {
                    pt = con.prepareStatement("insert into condidateregistration values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                    pt.setInt(1, id);
                    pt.setString(2, name);
                    pt.setString(3, age);
                    pt.setString(4, ge);
                    ...
                    pt.setString(13, "LogOut");
                    pt.setString(14, "Unregisted");
                    pt.executeUpdate();
        ...
        // TODO add your handling code here:
          if(!txtid.getText().equals("") && !txtname.getText().equals("") && !txtadd.getText().equals("") &&!txtadhar.getText().equals("")&& !cmbstate.getSelectedItem().equals("Select State") && ! txtage.getText().equals("") && ! txtnum.getText().equals("") && ! txtcountry.getText().equals("") && !cmbparty.getSelectedItem().equals("Select Party") && !txtemail.getText().equals("")&&!buttonGroup1.getSelection().equals(buttonGroup1.isSelected(null)))
          {
            ...
            int ds=str.indexOf('.');
             ...
             {
            int id = Integer.parseInt(txtid.getText());
            String name, num, st, co, ge,add,adhar, age,pass,cpass,email,party,date;
            party=(String)cmbparty.getSelectedItem();
            pass=txtpass.getText();
            cpass=txtCpass.getText();
            num = txtnum.getText();
