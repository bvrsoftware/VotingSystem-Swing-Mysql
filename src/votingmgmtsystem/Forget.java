    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(88, 88, 88)
                                .addComponent(txtCpass, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(236, 236, 236)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(342, 1103, Short.MAX_VALUE)
        ...
        // TODO add your handling code here:
         ...
         String sql1=" ";
            if (rdoC.isSelected() == true) {
                sql = "select*from CondidateRegistration where Id='"+id+"'and Number='"+cp+"'";
            }
            if (rdoV.isSelected() == true) {
                sql = "select*from VoterRegistration where Id='"+id+"'and Number='"+cp+"'";
            }
     else {
           try
            {
             ...
             if(rs.next())
             {
                ...
                msgbox.showMessageDialog(this,"Your id and Number Incorrect Please try again.");
