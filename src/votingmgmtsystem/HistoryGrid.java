...
public class HistoryGrid extends javax.swing.JFrame {
    ...
    Statement st;
    String U="Active";
    String [] cp=new String[]{"ID","Name","Age","Gender","Address","State","Country","Number","Adhar","Party","Email","Password","Status","Action"};
        ...
        try
           {        
               while(rs1.next())
               {
                   ...
                   ob[12]=rs1.getString(13);
                   ob[13]=rs1.getString(14);
                   dtmp.addRow(ob);
        ...
        public void votegrid()
  {
    ...
    private void initComponents() {
        ...
        cmbsearch.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Search With", "Id", "Name", "Number", "Party", "Age", "Gender", "Email", "Address", "State", " " }));
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
        ...
        {
            try{
                rs=st.executeQuery("select * from history where Age like '%"+str+"%'");
                fillgrid(rs);
        ...
        {
            try{
                rs=st.executeQuery("select * from history where Party like '%"+str+"%'");
                fillgrid(rs);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
