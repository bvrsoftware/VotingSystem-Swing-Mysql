    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtCpass, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtCpass, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(36, 36, 36)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        // TODO add your handling code here:
         ...
         String sql1=" ";
            if (rdoC.isSelected() == true) {
                sql = "select*from CondidateRegistration where Id='"+id+"'and Password='"+cp+"'";
                sql1="update condidateregistration set Password=? where Id='"+id+"' and Password='"+cp+"'";
            }
            if (rdoV.isSelected() == true) {
                sql = "select*from VoterRegistration where Id='"+id+"'and Password='"+cp+"'";
                sql1="update voterregistration set Password=? where Id='"+id+"' and Password='"+cp+"'";
            }
