...
public class VoterUpdate extends javax.swing.JFrame {
    ...
    {
         try{
              pt=con.prepareStatement("select Id from voterregistration order by Id");
              rs=pt.executeQuery();
              while(rs.next())
              {
                String id;
 ...
 /**
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Voter Update Profile");
        ...
        cmbid.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        if(!txtname.getText().equals("") && !txtadd.getText().equals("") &&!txtadhar.getText().equals("") && ! cmbstate.getSelectedItem().equals("Select State") && ! txtage.getText().equals("") && ! txtnum.getText().equals("")&& !txtemail.getText().equals("")&&!txtgender.getText().equals(""))
             {
            ...
            String name, num, st, adhar,add, age,email,date,ge;
          int  id=Integer.parseInt((String)cmbid.getSelectedItem());
            ...
            ge=txtgender.getText();
             try {
                    pt = con.prepareStatement("update VoterRegistration set Name=?,Age=?,Address=?,State=?,Number=?,Gender=?,Adhar=?,Email=?,Status=? where Id='"+id+"'");
                    pt.setString(1, name);
                    pt.setString(2, age);
                    pt.setString(3, add);
                    pt.setString(4, st);
